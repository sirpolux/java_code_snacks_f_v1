...
const Home = () => {
  ...
  return (
    <div className='h-screen w-full bg-white rounded-2xl flex items-center justify-center'>
        <div className='w-full h-full max-w-[500px] max-h-[700px] shadow rounded-2xl'>
